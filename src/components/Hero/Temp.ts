...
interface HeroSplitProps {
    useOverlay?: boolean; // Changed from useOverLay to useOverlay (consistent camelCase)
    title: string;
    subtitle?: string;
    ctaText?: string;
    ctaLink?: string;
...
export default function HeroSplit({
    ...
    return (
        <section
            className={`container d-flex align-items-center justify-content-center  py-5 min-vh-100 position-relative row-cols-2`}
        >
            <div
